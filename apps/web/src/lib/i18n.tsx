...
const STRINGS: Record<string, Record<Lang, string>> = {
  ...
  "home.buyNow": { lv: "Pērc uzreiz", ru: "Купить сейчас", en: "Buy now" },
  "home.empty": { lv: "Šobrīd izsoļu nav.", ru: "Сейчас аукционов нет.", en: "No auctions right now." },
  "buy.badge": { lv: "Pērc uzreiz", ru: "Купить сейчас", en: "Buy now" },
  "buy.price": { lv: "Cena", ru: "Цена", en: "Price" },
  "buy.vatNote": { lv: "Cenai tiek pievienots PVN.", ru: "К цене добавляется НДС.", en: "VAT is added to the price." },
  "buy.now": { lv: "Pirkt tagad", ru: "Купить сейчас", en: "Buy now" },
  "buy.signin": { lv: "Ienāciet, lai pirktu", ru: "Войдите, чтобы купить", en: "Sign in to buy" },
  "buy.soldOut": { lv: "Pārdots", ru: "Продано", en: "Sold out" },
  "buy.blocked": { lv: "Jūsu konts ir bloķēts.", ru: "Ваш аккаунт заблокирован.", en: "Your account is blocked." },
