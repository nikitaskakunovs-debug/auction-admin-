...
export const CONTENT = {
  ...
  "ads.f.imageHint": { lv: "Nav obligāts — bez tā kartītē paliek krāsa no tēmas.", ru: "Необязательно — без неё карточка останется цветом темы.", en: "Optional — without it the card keeps its theme colour." },
