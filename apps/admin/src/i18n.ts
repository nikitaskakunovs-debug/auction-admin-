...
const D = {
  ...
  // Phase E — report a problem
  "bug.title": { lv: "Ziņot par problēmu", ru: "Сообщить о проблеме", en: "Report a problem" },
  "bug.subtitle": { lv: "Nonāk pie IT ar visu kontekstu jau pievienotu.", ru: "Уходит в IT со всем контекстом.", en: "Goes straight to IT with the context already attached." },
  "bug.tabNew": { lv: "Jauns ziņojums", ru: "Новое сообщение", en: "New report" },
  "bug.tabMine": { lv: "Mani ziņojumi", ru: "Мои сообщения", en: "My reports" },
  "bug.bodyPlaceholder": { lv: "Aprakstiet problēmu vienā vai divos teikumos…", ru: "Опишите проблему в одном-двух предложениях…", en: "Describe the problem in a sentence or two…" },
  "bug.type": { lv: "Tips", ru: "Тип", en: "Type" },
  "bug.severity": { lv: "Cik nopietni?", ru: "Насколько серьёзно?", en: "Severity" },
  "bug.sev.low": { lv: "Zems", ru: "Низкая", en: "Low" },
  "bug.sev.normal": { lv: "Parasts", ru: "Обычная", en: "Normal" },
  "bug.sev.high": { lv: "Augsts", ru: "Высокая", en: "High" },
  "bug.sev.blocker": { lv: "Bloķē darbu", ru: "Блокирует", en: "Blocker" },
  "bug.steps": { lv: "Soļi, kā atkārtot (neobligāti)", ru: "Шаги воспроизведения (необязательно)", en: "Steps to reproduce (optional)" },
  "bug.attachments": { lv: "Ekrānšāviņi / video (neobligāti)", ru: "Скриншоты / видео (необязательно)", en: "Screenshots / video (optional)" },
  "bug.attach": { lv: "Pievienot failu", ru: "Прикрепить файл", en: "Attach image / video" },
  "bug.screenshot": { lv: "Ekrānšāviņš", ru: "Скриншот", en: "Screenshot" },
  "bug.record": { lv: "Ierakstīt ekrānu", ru: "Записать экран", en: "Record screen" },
  "bug.stopRec": { lv: "Apturēt ierakstu", ru: "Остановить запись", en: "Stop recording" },
  "bug.autoAttached": { lv: "Pievienots automātiski", ru: "Прикреплено автоматически", en: "Attached automatically" },
  "bug.autoAttachedHint": { lv: "— lai jums tas nav jāskaidro", ru: "— чтобы не объяснять вручную", en: "— so you don't have to explain it" },
  "bug.ctxScreen": { lv: "Ekrāns", ru: "Экран", en: "Screen" },
  "bug.ctxRole": { lv: "Loma", ru: "Роль", en: "Role" },
  "bug.ctxVersion": { lv: "Versija", ru: "Версия", en: "Version" },
  "bug.ctxConsole": { lv: "Žurnāls", ru: "Журнал", en: "Console" },
  "bug.ctxLines": { lv: "rindas", ru: "строк", en: "lines" },
  "bug.send": { lv: "Nosūtīt IT", ru: "Отправить в IT", en: "Send to IT" },
  "bug.sendHint": { lv: "Nonāk IT rindā ar visu augstāk redzamo kontekstu.", ru: "Уходит в очередь IT со всем контекстом выше.", en: "Routed to the IT queue with all the context above." },
  "bug.sendFailed": { lv: "Nosūtīšana neizdevās", ru: "Не удалось отправить", en: "Send failed" },
  "bug.uploadFailed": { lv: "Faila augšupielāde neizdevās", ru: "Не удалось загрузить файл", en: "Upload failed" },
  "bug.noReports": { lv: "Vēl nav neviena ziņojuma.", ru: "Пока нет сообщений.", en: "No reports yet." },
  "bug.itAsked": { lv: "IT uzdeva jautājumu — atveriet, lai atbildētu", ru: "IT задал вопрос — откройте, чтобы ответить", en: "IT asked a question — tap to reply" },
  "bug.allReports": { lv: "Visi ziņojumi", ru: "Все сообщения", en: "All reports" },
  "bug.chatWith": { lv: "Saruna ar IT", ru: "Чат с IT", en: "Chat with IT" },
  "bug.chatSynced": { lv: "sinhronizēts ar Jira", ru: "синхронизировано с Jira", en: "synced with the Jira ticket" },
  "bug.noMessages": { lv: "Vēl nav ziņu — IT atbildēs šeit.", ru: "Пока нет сообщений — IT ответит здесь.", en: "No messages yet — IT will reply here." },
  "bug.replyPlaceholder": { lv: "Atbildēt IT… (⌘↵ nosūta)", ru: "Ответить IT… (⌘↵ отправить)", en: "Reply to IT… (⌘↵ to send)" },
  "bug.sendReply": { lv: "Sūtīt", ru: "Отправить", en: "Send" },
  // W3 bin browser
  ...
  "wh.myStatus": { lv: "Mans statuss", ru: "Мой статус", en: "My status" },
  "wh.st.working": { lv: "Strādāju", ru: "Работаю", en: "Working" },
  "wh.st.coffee": { lv: "Kafija", ru: "Кофе", en: "Coffee" },
  "wh.st.lunch": { lv: "Pusdienas", ru: "Обед", en: "Lunch" },
  "wh.st.done": { lv: "Maiņa beigusies", ru: "Смена окончена", en: "Shift done" },
  "wh.statusSaved": { lv: "Statuss saglabāts", ru: "Статус сохранён", en: "Status saved" },
  "wh.statusFailed": { lv: "Statusu neizdevās saglabāt", ru: "Не удалось сохранить статус", en: "Couldn't save status" },
  "wh.passTicket": { lv: "Nodot šo talonu…", ru: "Передать этот талон…", en: "Pass this ticket…" },
  "wh.passWhy": { lv: "Kāpēc nododat?", ru: "Почему передаёте?", en: "Why are you passing it?" },
  "wh.passR.busy": { lv: "Pārāk aizņemts", ru: "Слишком занят", en: "Too busy" },
  "wh.passR.endShift": { lv: "Maiņas beigas", ru: "Конец смены", en: "End of shift" },
  "wh.passR.break": { lv: "Pārtraukums", ru: "Перерыв", en: "Break" },
  "wh.passR.needHelp": { lv: "Vajag palīdzību", ru: "Нужна помощь", en: "Need help" },
  "wh.passR.other": { lv: "Cits iemesls", ru: "Другая причина", en: "Other" },
  "wh.passOtherPlaceholder": { lv: "Īss iemesls…", ru: "Краткая причина…", en: "Short reason…" },
  "wh.passToWhom": { lv: "Kam nodot?", ru: "Кому передать?", en: "Pass to whom?" },
  "wh.passToQueue": { lv: "Atpakaļ rindā", ru: "Вернуть в очередь", en: "Back to the queue" },
  "wh.passQueued": { lv: "Talons atgriezts rindā", ru: "Талон возвращён в очередь", en: "Ticket returned to the queue" },
  "wh.passOffered": { lv: "Piedāvājums nosūtīts kolēģim", ru: "Предложение отправлено коллеге", en: "Offer sent to your colleague" },
  "wh.passesYou": { lv: "nodod jums talonu", ru: "передаёт вам талон", en: "passes you ticket" },
  "wh.accept": { lv: "Pieņemt", ru: "Принять", en: "Accept" },
  "wh.decline": { lv: "Atteikt", ru: "Отклонить", en: "Decline" },
  "wh.passAccepted": { lv: "Talons pieņemts — tas ir jūsu", ru: "Талон принят — он ваш", en: "Ticket accepted — it's yours" },
  "wh.passDeclined": { lv: "Piedāvājums atteikts", ru: "Предложение отклонено", en: "Offer declined" },
  "wh.free": { lv: "BRĪVS", ru: "СВОБОДЕН", en: "FREE" },
  "wh.busyWith": { lv: "AIZŅEMTS", ru: "ЗАНЯТ", en: "BUSY" },
  "wh.pull": { lv: "Noņemt no plaukta…", ru: "Снять с полки…", en: "Pull from shelf…" },
  "wh.pullWhy": { lv: "Kāpēc noņemt?", ru: "Почему снимаете?", en: "Why pull it?" },
  "wh.pullR.damaged": { lv: "Bojāts", ru: "Повреждён", en: "Damaged" },
  "wh.pullR.rephoto": { lv: "Pārfotografēt", ru: "Переснять фото", en: "Re-photograph" },
  "wh.pullR.regrade": { lv: "Pārvērtēt stāvokli", ru: "Переоценить состояние", en: "Re-grade" },
  "wh.pullR.recount": { lv: "Pārskaitīt", ru: "Пересчитать", en: "Recount" },
  "wh.pullR.other": { lv: "Cits", ru: "Другое", en: "Other" },
  "wh.pullNotePlaceholder": { lv: "Piezīme (neobligāta)…", ru: "Заметка (необязательно)…", en: "Note (optional)…" },
  "wh.pullConfirm": { lv: "Noņemt no plaukta", ru: "Снять с полки", en: "Pull from shelf" },
  "wh.pullQuar": { lv: "→ QUAR-01 · KARANTĪNA", ru: "→ QUAR-01 · КАРАНТИН", en: "→ QUAR-01 · QUARANTINE" },
  "wh.pulled": { lv: "Noņemts no plaukta", ru: "Снято с полки", en: "Pulled from the shelf" },
  "wh.pullFailed": { lv: "Neizdevās noņemt", ru: "Не удалось снять", en: "Pull failed" },
  "wh.scanSetupTitle": { lv: "Kameras skenera iestatīšana", ru: "Настройка сканера камерой", en: "Camera scanner setup" },
  "wh.scanStep1": { lv: "1. Nospiediet «Skenēt ar kameru» un atļaujiet kameras piekļuvi.", ru: "1. Нажмите «Сканировать камерой» и разрешите доступ к камере.", en: "1. Tap “Scan with camera” and allow camera access." },
  "wh.scanStep2": { lv: "2. iPhone: lai neprasa katru reizi — Safari adreses joslā “aA” → Vietnes iestatījumi → Kamera → Atļaut.", ru: "2. iPhone: чтобы не спрашивал каждый раз — в Safari «aA» в адресной строке → Настройки сайта → Камера → Разрешить.", en: "2. iPhone: to stop the repeated prompt — tap “aA” in Safari's address bar → Website Settings → Camera → Allow." },
  "wh.scanStep3": { lv: "3. Notēmējiet uz etiķetes QR kodu — tas nolasās automātiski.", ru: "3. Наведите на QR-код этикетки — он считается автоматически.", en: "3. Aim at the label's QR — it reads automatically." },
  "wh.tryScan": { lv: "Izmēģināt skenēšanu", ru: "Попробовать скан", en: "Try a scan" },
  "wh.hideCard": { lv: "Gatavs, paslēpt", ru: "Готово, скрыть", en: "Done, hide this" },
